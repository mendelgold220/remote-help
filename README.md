...
- Screen Sharing runs in "ask permission" mode: the helper connects with Screen Sharing (vnc://<address>) and chooses "By asking for permission"; the owner must click Share Screen each time. The legacy VNC password is disabled.
